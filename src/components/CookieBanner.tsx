      ...
      <AnimatePresence>
        {shouldShowBanner && (
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-[60] p-4 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-t border-gray-200 dark:border-gray-700 shadow-2xl"
          >
